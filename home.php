  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar bg-gradient-primary sidebar-dark accordion" id="accordionSidebar" >
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="?p=dashboard">
        ...
        <div class="sidebar-brand-text mx-3"><img src="img/logo.png" width="50"></div>
        <b>Apotek Elera</b>
      </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            Copyright &#169; <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script> | STMIK EL RAHMA || PPL KEL 05</a>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
